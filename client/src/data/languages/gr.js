export default {
    ...
    'CLOSE_TICKET': 'Κλείσιμο εισιτήριου',
    ...
    'CUSTOM_RESPONSES': 'Προσαρμοσμένες Απαντήσεις',
    ...
    'NEXT': 'Επόμενο',
    'SUBJECT': 'Θέμα',
    'SEND_EMAIL_ON_NEW_TICKET': 'Στείλτε μήνυμα ηλεκτρονικού ταχυδρομείου στο νέο εισιτήριο',
    ...
    'ACTIVITY_DELETE_DEPARTMENT': 'Διαγραμμένο τμήμα',
    ...
    'ACTIVITY_BAN_USER': 'Αποκλεισμένος χρήστης',
    'ACTIVITY_DELETE_USER': 'Διαγραμμένος χρήστη',
    'ACTIVITY_UN_BAN_USER': 'Μη απακλεισμός χρήστη',
    ...
    'ERROR_EMAIL': 'Μη έγκυρη ηλεκτρονική διεύθυνση',
